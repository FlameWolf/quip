	...
	return (
		<form ref={signUpForm} onInput={updateFormValidity}>
			...
			<div class="input-group mb-4">
				...
				<span class="input-group-text clickable" onClick={(event: Event) => setShowPassword(value => !value)}>
			...
			<div class="input-group mb-4">
				...
				<span class="input-group-text clickable" onClick={(event: Event) => setShowConfirmPassword(value => !value)}>
